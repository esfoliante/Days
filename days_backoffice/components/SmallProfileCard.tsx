...
const SmallProfileCard: React.FC<ProfileCardProps> = ({ name, image, canEdit = true, action, cardID }) => (
    <div className="col-span-1 h-72 shadow rounded-md items-center text-center">
